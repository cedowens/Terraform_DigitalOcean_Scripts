...
cd DO_new_ubuntu_with_gophish

sed -i -e "s/myc2-1/$dropletName/g" droplet-config-with-gophish.tf
sed -i -e "s/myc2rule/$firewallName/g" droplet-config-with-gophish.tf
sed -i -e "s/keyname/$keyName/g" init.tf
sed -i -e "s/keyname/$keyName/g" droplet-config-with-gophish.tf
sed -i -e "s/127.0.0.1/$adminIP/g" droplet-config-with-gophish.tf
...
cp ini-orig init.tf
cp drop-orig droplet-config-with-gophish.tf
